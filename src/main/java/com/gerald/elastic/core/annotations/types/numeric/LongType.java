...
import com.gerald.elastic.core.annotations.handlers.extractors.types.numeric.LongExtractor;
...
@TypeMapping(javaType = Long.class, elasticType = "long", extractor = LongExtractor.class)
public @interface LongType {
	...
	/**
	 * null替换值。如果是空串，表示null；其他值，将被转换为Long，转换失败，将抛出IllegalArgumentException
	 * 
	 * @return null替换值
	 */
