...
import com.gerald.elastic.core.annotations.handlers.extractors.types.numeric.ByteExtractor;
...
@TypeMapping(javaType = Byte.class, elasticType = "byte", extractor = ByteExtractor.class)
public @interface ByteType {
	...
	/**
	 * null替换值。如果是空串，表示null；其他值，将被转换为Byte，转换失败，将抛出IllegalArgumentException
	 * 
	 * @return null替换值
	 */
