...
import com.gerald.elastic.core.annotations.handlers.extractors.types.numeric.ShortExtractor;
...
@TypeMapping(javaType = Short.class, elasticType = "short", extractor = ShortExtractor.class)
public @interface ShortType {
	...
	/**
	 * null替换值。如果是空串，表示null；其他值，将被转换为Short，转换失败，将抛出IllegalArgumentException
	 * 
	 * @return null替换值
	 */
