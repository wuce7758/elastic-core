...
import com.gerald.elastic.core.annotations.handlers.extractors.types.StringExtractor;
import com.gerald.elastic.core.annotations.mapping.parameter.Fields;
...
@TypeMapping(javaType = String.class, elasticType = "string", extractor = StringExtractor.class)
