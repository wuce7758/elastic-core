...
import com.gerald.elastic.core.annotations.handlers.extractors.types.numeric.FloatExtractor;
...
@TypeMapping(javaType = Float.class, elasticType = "float", extractor = FloatExtractor.class)
public @interface FloatType {
	...
	/**
	 * null替换值。如果是空串，表示null；其他值，将被转换为Float，转换失败，将抛出IllegalArgumentException
	 * 
	 * @return null替换值
	 */
