...
import com.gerald.elastic.core.annotations.handlers.extractors.types.numeric.DoubleExtractor;
...
@TypeMapping(javaType = Double.class, elasticType = "double", extractor = DoubleExtractor.class)
public @interface DoubleType {
	...
	/**
	 * null替换值。如果是空串，表示null；其他值，将被转换为Double，转换失败，将抛出IllegalArgumentException
	 * 
	 * @return null替换值
	 */
